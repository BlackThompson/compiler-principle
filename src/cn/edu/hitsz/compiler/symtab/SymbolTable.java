...
public class SymbolTable {
    ...
    private ArrayList<SymbolTableEntry> symbolTableEntries = new ArrayList<>();
    ...
    public SymbolTableEntry add(String text) {
        ...
        symbolTableEntries.add(symbolTableEntry);
        return symbolTableEntry;
    }
    ...
    private Map<String, SymbolTableEntry> getAllEntries() {
        Map<String, SymbolTableEntry> symbolMap = new HashMap<>();
        for (SymbolTableEntry symbolTableEntry : symbolTableEntries) {
            symbolMap.put(symbolTableEntry.getText(), symbolTableEntry);
